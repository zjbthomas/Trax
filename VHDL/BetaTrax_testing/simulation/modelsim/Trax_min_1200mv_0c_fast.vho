...
-- Rx_data[0]	=>  Location: PIN_G19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Rx_data[1]	=>  Location: PIN_F19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Rx_data[2]	=>  Location: PIN_E19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Rx_data[3]	=>  Location: PIN_F21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Rx_data[4]	=>  Location: PIN_F18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Rx_data[5]	=>  Location: PIN_E18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Rx_data[6]	=>  Location: PIN_J19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Rx_data[7]	=>  Location: PIN_H19,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \move_translator_inst|Equal0~0_combout\ : std_logic;
...
SIGNAL \move_translator_inst|Equal0~1_combout\ : std_logic;
...
SIGNAL \move_translator_inst|Equal0~2_combout\ : std_logic;
...
SIGNAL \move_translator_inst|uut0|counter[12]~0_combout\ : std_logic;
...
SIGNAL \move_translator_inst|uut0|Txd~4_combout\ : std_logic;
SIGNAL \move_translator_inst|uut0|reg[0]~0_combout\ : std_logic;
SIGNAL \move_translator_inst|uut0|Txd~5_combout\ : std_logic;
SIGNAL \move_translator_inst|uut0|Txd~7_combout\ : std_logic;
SIGNAL \move_translator_inst|uut0|Txd~6_combout\ : std_logic;
...
SIGNAL ALT_INV_x : std_logic_vector(0 DOWNTO 0);
...
-- Equation(s):
-- \counter~23_combout\ = (!\Add0~52_combout\ & \Add0~4_combout\)
...
-- Equation(s):
-- \counter~22_combout\ = (!\Add0~52_combout\ & \Add0~6_combout\)
...
-- Equation(s):
-- \counter~16_combout\ = (!\Add0~52_combout\ & \Add0~18_combout\)
...
-- Equation(s):
-- \move_translator_inst|x_last[1]~7_combout\ = \move_translator_inst|x_last[1]~5_combout\ $ (x(1))
...
PORT MAP (
	...
	clrn => \reset~input_o\,
	ena => \move_translator_inst|process_0~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	dataa => x(0),
	datac => \move_translator_inst|x_last[0]~1_combout\,
...
PORT MAP (
	dataa => x(0),
	datab => \move_translator_inst|x_last[0]~_emulated_q\,
	datac => \move_translator_inst|x_last[0]~1_combout\,
	datad => \reset~input_o\,
	combout => \move_translator_inst|x_last[0]~2_combout\);

-- Location: LCCOMB_X113_Y40_N8
\move_translator_inst|Equal0~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \move_translator_inst|Equal0~0_combout\ = (x(0) & (!\move_translator_inst|x_last[0]~2_combout\ & (x(1) $ (!\move_translator_inst|x_last[1]~6_combout\)))) # (!x(0) & (\move_translator_inst|x_last[0]~2_combout\ & (x(1) $ 
...
PORT MAP (
	...
	combout => \move_translator_inst|Equal0~0_combout\);
...
PORT MAP (
	clk => \pll_inst|altpll_component|auto_generated|wire_pll1_clk[0]~clkctrl_outclk\,
	asdata => \move_translator_inst|x_last[2]~11_combout\,
	clrn => \reset~input_o\,
	sload => VCC,
	ena => \move_translator_inst|process_0~0_combout\,
	devclrn => ww_devclrn,
...
-- Equation(s):
-- \move_translator_inst|x_last[2]~10_combout\ = (\reset~input_o\ & ((\move_translator_inst|x_last[2]~9_combout\ $ (\move_translator_inst|x_last[2]~_emulated_q\)))) # (!\reset~input_o\ & (x(2)))
...
-- Equation(s):
-- \move_translator_inst|x_last[3]~15_combout\ = x(3) $ (\move_translator_inst|x_last[3]~13_combout\)
...
\move_translator_inst|Equal0~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \move_translator_inst|Equal0~1_combout\ = (x(2) & (\move_translator_inst|x_last[2]~10_combout\ & (x(3) $ (!\move_translator_inst|x_last[3]~14_combout\)))) # (!x(2) & (!\move_translator_inst|x_last[2]~10_combout\ & (x(3) $ 
-- (!\move_translator_inst|x_last[3]~14_combout\))))
...
PORT MAP (
	...
	combout => \move_translator_inst|Equal0~1_combout\);
...
PORT MAP (
	clk => \pll_inst|altpll_component|auto_generated|wire_pll1_clk[0]~clkctrl_outclk\,
	asdata => \move_translator_inst|x_last[4]~19_combout\,
	clrn => \reset~input_o\,
	sload => VCC,
	ena => \move_translator_inst|process_0~0_combout\,
	devclrn => ww_devclrn,
...
\move_translator_inst|Equal0~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \move_translator_inst|Equal0~2_combout\ = x(4) $ (\move_translator_inst|x_last[4]~18_combout\)
...
PORT MAP (
	...
	combout => \move_translator_inst|Equal0~2_combout\);

-- Location: LCCOMB_X113_Y40_N14
\move_translator_inst|process_0~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \move_translator_inst|process_0~0_combout\ = (!\move_translator_inst|uut0|state.idle~q\ & (((\move_translator_inst|Equal0~2_combout\) # (!\move_translator_inst|Equal0~1_combout\)) # (!\move_translator_inst|Equal0~0_combout\)))
...
PORT MAP (
	...
	datab => \move_translator_inst|Equal0~0_combout\,
	datac => \move_translator_inst|Equal0~1_combout\,
	datad => \move_translator_inst|Equal0~2_combout\,
...
PORT MAP (
	clk => \pll_inst|altpll_component|auto_generated|wire_pll1_clk[0]~clkctrl_outclk\,
	d => \move_translator_inst|process_0~0_combout\,
	clrn => \reset~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	clk => \pll_inst|altpll_component|auto_generated|wire_pll1_clk[0]~clkctrl_outclk\,
	asdata => \move_translator_inst|uut0|state.bit6~q\,
	clrn => \reset~input_o\,
	sload => VCC,
	ena => \move_translator_inst|uut0|state~19_combout\,
	devclrn => ww_devclrn,
...
-- pragma translate_on
PORT MAP (
	dataa => \move_translator_inst|uut0|counter\(0),
	datad => VCC,
...
\move_translator_inst|uut0|counter[12]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \move_translator_inst|uut0|counter[12]~0_combout\ = (\move_translator_inst|uut0|state.idle~q\) # (\move_translator_inst|Tx_en~q\)
...
PORT MAP (
	datab => \move_translator_inst|uut0|state.idle~q\,
	datad => \move_translator_inst|Tx_en~q\,
	combout => \move_translator_inst|uut0|counter[12]~0_combout\);
...
PORT MAP (
	...
	clrn => \reset~input_o\,
	ena => \move_translator_inst|uut0|counter[12]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \move_translator_inst|uut0|Add0~33_combout\ = (\move_translator_inst|uut0|state.idle~q\ & (\move_translator_inst|uut0|LessThan0~4_combout\ & \move_translator_inst|uut0|Add0~2_combout\))
...
-- Equation(s):
-- \move_translator_inst|uut0|Add0~31_combout\ = (\move_translator_inst|uut0|LessThan0~4_combout\ & (\move_translator_inst|uut0|state.idle~q\ & \move_translator_inst|uut0|Add0~14_combout\))
...
PORT MAP (
	datab => \move_translator_inst|uut0|LessThan0~4_combout\,
	datac => \move_translator_inst|uut0|state.idle~q\,
	datad => \move_translator_inst|uut0|Add0~14_combout\,
...
-- Equation(s):
-- \move_translator_inst|uut0|Add0~25_combout\ = (\move_translator_inst|uut0|LessThan0~4_combout\ & (\move_translator_inst|uut0|state.idle~q\ & \move_translator_inst|uut0|Add0~20_combout\))
...
-- Equation(s):
-- \move_translator_inst|uut0|LessThan0~1_combout\ = (!\move_translator_inst|uut0|counter\(9) & (!\move_translator_inst|uut0|counter\(11) & (!\move_translator_inst|uut0|counter\(8) & !\move_translator_inst|uut0|counter\(7))))
...
PORT MAP (
	...
	datad => \move_translator_inst|uut0|counter\(7),
...
PORT MAP (
	...
	datad => \move_translator_inst|uut0|counter\(10),
...
-- Equation(s):
-- \move_translator_inst|uut0|LessThan0~2_combout\ = (!\move_translator_inst|uut0|counter\(3) & (!\move_translator_inst|uut0|counter\(5) & ((!\move_translator_inst|uut0|counter\(2)) # (!\move_translator_inst|uut0|counter\(1)))))
...
\move_translator_inst|uut0|Txd~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \move_translator_inst|uut0|Txd~4_combout\ = (\move_translator_inst|uut0|state.bit0~q\) # ((\move_translator_inst|uut0|state.bit1~q\) # ((\move_translator_inst|uut0|state.bit2~q\) # (\move_translator_inst|uut0|state.start~q\)))
...
PORT MAP (
	...
	datac => \move_translator_inst|uut0|state.bit2~q\,
	datad => \move_translator_inst|uut0|state.start~q\,
	combout => \move_translator_inst|uut0|Txd~4_combout\);

-- Location: LCCOMB_X111_Y40_N20
\move_translator_inst|uut0|reg[0]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \move_translator_inst|uut0|reg[0]~0_combout\ = (\move_translator_inst|uut0|reg\(0)) # ((!\move_translator_inst|uut0|state.idle~q\ & \move_translator_inst|Tx_en~q\))
...
PORT MAP (
	...
	datad => \move_translator_inst|Tx_en~q\,
	combout => \move_translator_inst|uut0|reg[0]~0_combout\);
...
PORT MAP (
	clk => \pll_inst|altpll_component|auto_generated|wire_pll1_clk[0]~clkctrl_outclk\,
	d => \move_translator_inst|uut0|reg[0]~0_combout\,
	clrn => \reset~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\move_translator_inst|uut0|Txd~5\ : cycloneive_lcell_comb
-- Equation(s):
-- \move_translator_inst|uut0|Txd~5_combout\ = (\move_translator_inst|uut0|state.stop~q\) # ((\move_translator_inst|uut0|reg\(0) & ((\move_translator_inst|uut0|Txd~4_combout\) # (\move_translator_inst|uut0|state.bit4~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \move_translator_inst|uut0|Txd~4_combout\,
	datab => \move_translator_inst|uut0|reg\(0),
	datac => \move_translator_inst|uut0|state.bit4~q\,
	datad => \move_translator_inst|uut0|state.stop~q\,
	combout => \move_translator_inst|uut0|Txd~5_combout\);

-- Location: LCCOMB_X111_Y40_N30
\move_translator_inst|uut0|Txd~7\ : cycloneive_lcell_comb
-- Equation(s):
-- \move_translator_inst|uut0|Txd~7_combout\ = (\move_translator_inst|uut0|state.idle~q\ & ((\move_translator_inst|uut0|Txd~5_combout\) # ((\move_translator_inst|uut0|state.bit7~q\)))) # (!\move_translator_inst|uut0|state.idle~q\ & 
-- (((\move_translator_inst|Tx_en~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \move_translator_inst|uut0|Txd~5_combout\,
	datab => \move_translator_inst|uut0|state.idle~q\,
	datac => \move_translator_inst|uut0|state.bit7~q\,
	datad => \move_translator_inst|Tx_en~q\,
	combout => \move_translator_inst|uut0|Txd~7_combout\);

-- Location: LCCOMB_X111_Y40_N12
\move_translator_inst|uut0|Txd~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \move_translator_inst|uut0|Txd~6_combout\ = (\move_translator_inst|uut0|state.idle~q\ & ((\move_translator_inst|uut0|LessThan0~4_combout\ & ((\move_translator_inst|uut0|Txd~q\))) # (!\move_translator_inst|uut0|LessThan0~4_combout\ & 
-- (!\move_translator_inst|uut0|Txd~7_combout\)))) # (!\move_translator_inst|uut0|state.idle~q\ & (((\move_translator_inst|uut0|Txd~7_combout\) # (\move_translator_inst|uut0|Txd~q\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1011000111111100",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \move_translator_inst|uut0|LessThan0~4_combout\,
	datab => \move_translator_inst|uut0|Txd~7_combout\,
	datac => \move_translator_inst|uut0|Txd~q\,
	datad => \move_translator_inst|uut0|state.idle~q\,
	combout => \move_translator_inst|uut0|Txd~6_combout\);
...
PORT MAP (
	clk => \pll_inst|altpll_component|auto_generated|wire_pll1_clk[0]~clkctrl_outclk\,
	d => \move_translator_inst|uut0|Txd~6_combout\,
	clrn => \reset~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
